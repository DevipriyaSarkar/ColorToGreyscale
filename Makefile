...
student: main.o convert_image.o compare.o reference_calc.o Makefile
	$(NVCC) -o HW1 main.o convert_image.o compare.o reference_calc.o -L $(OPENCV_LIBPATH) $(OPENCV_LIBS) $(NVCC_OPTS)
...
convert_image.o: convert_image.cu utils.h
	nvcc -c convert_image.cu $(NVCC_OPTS)
